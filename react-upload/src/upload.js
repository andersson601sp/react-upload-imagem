...
function Upload() {
  ...
  async function handleUpload(event) {
    ...
    try {
      ...
      //preparando a imagem para envio
      const formData = new FormData()
      formData.append('imagem', imagem);

      //enviando e recuperando a imagem
    ...
    <div>
      ...
      <Jumbotron>
        <Form onSubmit={handleUpload} noValidate>
          {/**Elemento de selecionar a imagem */}
          <Form.Group>
            <Form.Label>Selecione a imagem (PNG ou JPEG).</Form.Label>
            <Form.Control type="file" onChange={handleImagem} accept="image/png, image/jpeg" />
          </Form.Group>
          {/**Botao de enviar */}
